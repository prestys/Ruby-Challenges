...
RSpec.describe PasswordManager2 do
  describe '#add' do
    ...
    context 'when the password is not valid' do
      it 'it is not added' do
        password_manager = PasswordManager2.new
        password_manager.add('acebook', 'password123')
        password_manager.add('makersbnb', 'qwerty@')
  ...
  describe '#update' do
    ...
    context 'when the updated password is not valid' do
      it 'it is not added' do
        password_manager = PasswordManager2.new
        password_manager.add('acebook', 'password123!')
        password_manager.add('makersbnb', 'qwerty789@')
        password_manager.update('acebook', 'password123')
        password_manager.update('makersbnb', 'qwerty@')
        expect(password_manager.password_for('acebook')).to eq 'password123!'
        expect(password_manager.password_for('makersbnb')).to eq 'qwerty789@'
      end
    end
